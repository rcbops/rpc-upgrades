...
export DEFAULT_KERNEL="linux-image-4.4.0-66-generic"
...
# checkout rpc-openstack
if [ ! -d "/opt/rpc-openstack" ]; then
  git clone -b ${RPC_BRANCH} --recursive https://github.com/rcbops/rpc-openstack /opt/rpc-openstack
else
...
${MNAIO_SSH} "pushd /opt/rpc-openstack; \
