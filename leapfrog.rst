...
* `r14.20.0 <https://github.com/rcbops/rpc-openstack/tree/r14.20.0>`_: The RPCO release of OpenStack Newton.
...
**Note:** *Currently the rpc-upgrades repo targets r14.20.0.  If you want to deploy the previous version you can:*

.. code-block:: shell

   export RPC_TARGET_CHECKOUT=r14.19.0
