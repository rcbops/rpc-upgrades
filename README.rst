...
* `r14.14.0 <https://github.com/rcbops/rpc-openstack/tree/r14.14.0>`_: The RPCO release of OpenStack Newton.
...
**Note:** *Currently the rpc-upgrades repo targets r14.14.0.  If you want to deploy the previous version you can:*

.. code-block:: shell

   export RPC_TARGET_CHECKOUT=r14.13.0
