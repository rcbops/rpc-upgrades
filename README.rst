...
* `r14.7.0 <https://github.com/rcbops/rpc-openstack/tree/r14.7.0>`_: The seventh RPCO release of OpenStack Newton.
...
**Note:** *Currently the rpc-upgrades repo targets r14.7.0.  If you want to deploy another version you can:*

.. code-block:: shell

   export RPC_TARGET_CHECKOUT=r14.6.0
